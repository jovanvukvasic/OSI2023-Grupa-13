    ...
    while(ind!="KRAJ"){
        ...
        if (ind=="PRIJAVA") korisnik1.prijaviSe();
            ...
            if(ind3=="ALL"){
                ...
                std::cout<<"Min: "; std::cin>>cijen1;
                std::cout<<"Max: "; std::cin>>cijen2;
                for(Nekretnina nekretnina : nekretnine) {
                    double cijeena;
                    cijeena=nekretnina.getCijena();
                    if(cijeena>=cijen1 && cijeena<=cijen2)nekretnina.prikaziInformacije();
                }
            }
                ...
                for(Nekretnina nekretnina : nekretnine) {
                    ...
                    if(nekretnina.getAdresa()==adresa1) nekretnina.prikaziInformacije();
                }
            }
                ...
                for(Nekretnina nekretnina : nekretnine) {
                    ...
                    if(nekretnina.getTip()==tt) nekretnina.prikaziInformacije();
                }
            }
            ...
            if (brojaaac==0)std::cout<<"Nema nekretnine sa tim identifikacionim brojem.\n";
