...
void Korisnik::registrujSe()
{
    ...
    while (provjeriPostojanjeKorisnickogImena())
    {
...
bool Korisnik::provjeriPostojanjeKorisnickogImena() const
{
    ...
    while (std::getline(file, line))
    {
        ...
        if (!(iss >> br >> existingUsername))
        {
            std::cerr << "Greška pri čitanju korisničkog imena iz linije: " << line << std::endl;
            continue;
        }
